...
namespace Common
{
    ...
    public class Auth
    {
        ...
        public static TMSalesManager.Models.user AuthUser = null;
        public static void setAuth(TMSalesManager.Models.user user)
        {
            AuthUser = user;
            isAuth = true;
            //id = user.id;
    ...
    public class AuthStatic
    {
        ...
        {
            TMSalesManager.Models.user user = new TMSalesManager.Models.user();
